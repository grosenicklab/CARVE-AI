...
if __name__ == '__main__':   
    ...
    res = pool.map(smap, [f_GbmBreastLungCancer_a, f_GbmBreastLungCancer_b, f_GbmBreastLungCancer_c, f_GbmBreastLungCancer_d, f_GbmBreastLungCancer_e, f_GbmBreastLungCancer_f])
