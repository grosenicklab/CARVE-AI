...
echo python ${code_path}experiments/icml-2022/aistats_genomics_run_SRBCT.py $code_path
python ${code_path}experiments/icml-2022/aistats_genomics_run_SRBCT.py $code_path