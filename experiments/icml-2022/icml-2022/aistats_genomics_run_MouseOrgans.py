...
if __name__ == '__main__':   
    ...
    res = pool.map(smap, [f_MouseOrgans_a, f_MouseOrgans_b, f_MouseOrgans_c, f_MouseOrgans_d, f_MouseOrgans_e, f_MouseOrgans_f, f_MouseOrgans_g, f_MouseOrgans_h, f_MouseOrgans_i])
